...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { categoria: @price.categoria, horas: @price.horas, valor: @price.valor, vehicle_id: @price.vehicle_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { categoria: @price.categoria, horas: @price.horas, valor: @price.valor, vehicle_id: @price.vehicle_id } }
